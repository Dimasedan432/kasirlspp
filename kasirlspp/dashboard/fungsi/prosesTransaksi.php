...
if ($uang < $total_bayar) {
    ...
    $queryTambah = "INSERT INTO tb_transaksi VALUES(NULL,  '$id_order', '$tanggal', '$tanggal2',  '$total_bayar', '$uang', '$kembalian')";
    $query = mysqli_query($kon, $queryTambah);
    if ($query > 0) {
        $_SESSION['pesan'] = '
        <div class="alert alert-success mb-2 alert-dismissible text-small " role="alert">
         Transaksi berhasil <a class="btn btn-sm btn-primary" href="admin/print_struk.php?id_order=' . $id_order . '" target="_blank">Print Struk <i class="fa fa-print"></i></a>
            <button type="button" class="close" data-dismiss="alert" aria-label="close"><span aria-hidden="true">&times;</span></button>
        </div>
        ';
