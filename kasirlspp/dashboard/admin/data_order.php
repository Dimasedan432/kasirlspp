                ...
                ?>
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <a href="fungsi/hapusPesan.php?id=<?= $orders['id_order'] ?>" class="btn btn-outline-dark btn-sm text-small" onclick="return confirm('Yakin ingin menghapus data ini ?')"><i class="fas fa-trash">hapus</i></a>
                                <button type="button" title="Detail Order" class="btn btn-sm btn-secondary text-small text-white" data-toggle="modal" data-target="#detailOrder_<?= $orders['id_order'] ?>"><i class="fas fa-eye">lihat</i></button>
